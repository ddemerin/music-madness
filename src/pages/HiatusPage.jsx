    ...
    <>
      <div className="band-page-container">
        ...
        <p className="blurb">
          ...
          ensemble, augmenting tracks with small yet delightful details, from
          the classic hip-hop piano break that closes “Swamp Thing” to the
          stop-start beats of “Breathing Underwater” that sound like gulps of
          air. Throughout, lead singer and rhythm guitarist Nai Palm’s elastic
          vocals explore the nuances of yearning and desire, as she yelps, coos,
